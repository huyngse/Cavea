        ...
        <div className="row mb-3  p-3 shadow">
            ...
            <div className='col-9'>
                ...
                <div className="row">
                    ...
                    <div className="col-3">
                        <p>
                            Giá sản phẩm: {props.price.toLocaleString("vi-VN", {
                                style: "currency",
                                currency: "VND",
                            })}
                        </p>
                        <p>
                            Thành tiền: {props.cost.toLocaleString("vi-VN", {
                                style: "currency",
                                currency: "VND",
                            })}
                        </p>
                        ...
                        <>
                            <div className="col-3 d-flex flex-column">
                                ...
                                <div className="text-center mt-auto d-flex align-items-center">
                                    ...
                                    <input type="number" className="form-control no-arrow" value={1} onChange={handleChangeQuantity}/>
                                    <button className="btn"
                                    >
                                        +
                                    </button>
                        ...
                        <>
                            <div className="col-3 d-flex flex-column">
                                ...
                                <div className="text-center mt-auto d-flex align-items-center">
                                    ...
                                    <input type="number" className="form-control no-arrow" value={props.quantity} onChange={handleChangeQuantity}/>
                                    <button className="btn"
