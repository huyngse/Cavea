...
const HeaderCarousel = () => {
  var banners = [
    {
      image:
        "https://minhocmit.com/wp-content/uploads/2022/12/b0eff0d933c2c89c91d3-scaled.jpg",
      href: "https://minhocmit.com/tag/di%CC%A3a-chi%CC%89-ban-long-chim-do%CC%A3c-de%CC%A3p/",
    },
    {
      image:
        "https://www.sieuthilongchim.net//img/webroot/upload/image/files/slide(1).png",
      href: "https://www.sieuthilongchim.net/",
    },
    {
      image:
        "https://www.sieuthilongchim.net//img/webroot/upload/image/files/l%E1%BB%93ng%20cu%20g%C3%A1y/canhluatreotuong.png",
  ...
  return (
    <div
      ...
      className="carousel slide carousel-page carousel-fade"
