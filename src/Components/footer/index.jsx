...
//ICON PNG
import facebook from '../../images/mini-icon/facebook.png';
import instagram from '../../images/mini-icon/instagram.png';
import youtube from '../../images/mini-icon/youtube.png';
import zalo from '../../images/mini-icon/zalo.png';
...
export default class Footer extends Component {
  ...
  render() {
    return (
      <div style={colorDiv} className="footer">
        <Grid container spacing={2}>
          <Grid item xs={12} lg={5}>
            ...
            <Typography variant="body1" gutterBottom>
              Chuyên Bán Buôn - Bán Lẻ, nhận đặt các loại lồng chim: Chào mào, Mi, Khướu, Khuyên, Chòe, Gáy, Sơn Ca, Yến ...
            </Typography>
            <div style={{ display: 'flex', gap: '15px' }}>
              <img src={facebook} width="30px" alt="facebook icon"></img>
              <img src={instagram} width="30px" alt="instagram icon"></img>
              <img src={youtube} width="30px" alt="youtube icon"></img>
              <img src={zalo} width="30px" alt="zalo icon"></img>
          ...
          <Grid item xs={12} lg={2}>
            ...
            <div className="footer-link-box">
              <div>
                <a href="https://www.google.com">Vị trí cử hàng</a>
              </div>
              <div>
                <a href="https://www.google.com">Tài khoản của tôi</a>
              </div>
              <div>
                <a href="https://www.google.com">Theo dõi đơn hàng</a>
              </div>
              <div>
                <a href="https://www.google.com">Câu hỏi thường gặp</a>
              </div>
            </div>
          </Grid>
          <Grid item xs={12} lg={2}>
            ...
            <div className="footer-link-box">
              <div>
                <a href="https://www.google.com">Giới thiệu về Cavea</a>
              </div>
              <div>
                <a href="https://www.google.com">Điều khoản sử dụng</a>
              </div>
              <div>
                <a href="https://www.google.com">Chính sách bảo mật</a>
              </div>
              <div>
                <a href="https://www.google.com">Chính sách hoàn trả</a>
              </div>
              <div>
                <a href="https://www.google.com">Vận chuyển</a>
              </div>
            </div>
          ...
          <Grid item xs={12} lg={3}>
            ...
            <div className="d-flex">
              ...
              <Typography variant="body1" gutterBottom>
                650 Lê Duẩn, Thắng Lợi, Thành phố Pleiku, Gia Lai, Việt Nam
              </Typography>
            </div>
