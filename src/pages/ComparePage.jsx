...
export default function CompareForm() {
  ...
  return (
    <MainLayout>
        ...
        <table className="m-3 table mx-auto shadow" style={{ width: "fit-content" }}>
          <tbody >
            <tr>
            ...
            <tr>
              ...
              {compareProductDetails.map((product) => (
                <td key={product.id}>{product.price.toLocaleString("vi-VN", {
                  style: "currency",
                  currency: "VND",
                })}</td>
              ))}
            ...
            <tr>
              ...
              {compareProductDetails.map((product) => (
                <td key={product.id}>{product.discount.toLocaleString("vi-VN", {
                  style: "currency",
                  currency: "VND",
                })}</td>
              ))}
