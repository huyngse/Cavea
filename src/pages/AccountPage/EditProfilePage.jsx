      ...
      <div className="py-3 px-4 bg-white ">
        ...
        <div className="row">
          ...
          <div className="col-4 d-flex align-items-center flex-column border-start ">
            <label
              htmlFor="avartar-file"
              className="object-fit-cover object-position-center rounded-circle overflow-hidden mt-4 mb-4"
            ...
            <div className="mb-3">
              ...
              <button className="btn btn-outline-primary">
                {" "}
                <label htmlFor="avartar-file" style={{ cursor: "pointer" }}>
                  Chọn file
                </label>
              </button>
            </div>
