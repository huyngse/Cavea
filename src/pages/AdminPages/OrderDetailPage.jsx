        ...
        < AdminLayout >
            <div className="bg-gray p-3">
                    ...
                    <table className='table table-bordered mb-5'>
                        <thead className='text-center'>
                            <tr >
                                ...
                                <th style={{ minWidth: "100px" }} className='bg-primary text-white align-middle'>
                                    Số lượng
                                </th>
                                <th style={{ minWidth: "100px" }} className='bg-primary text-white align-middle'>
                                    Số lượng tồn
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <div>
                        <a href="/admin/manage-order">&lt;&lt;&lt; Quay về danh sánh đơn hàng</a>
                    </div>
                    <div className="text-end">
                        <button className="btn btn-danger me-3" onClick={handleOpenDenyModal}>Từ chối</button>
                        <button className="btn btn-primary" onClick={handleOpenAcceptModal}>Chấp nhận</button>
                    </div>
                </div>
            </div>
            <Modal
            ...
            >
                <div style={{ width: "500px" }} className="bg-white p-3 mt-5 position-absolute start-50 translate-middle-x">
                    <h3 className="h4">Từ chối đơn hàng</h3>
                    <hr />
                    <div className="mb-3">
                        <label htmlFor="denyMessage" className="form-label h6 text-muted text-center w-100">Nhập lý do từ chối đơn hàng</label>
                        <textarea className="form-control" id="denyMessage" rows="3"></textarea>
                    </div>
                    <div className="text-end">
                        <button type="button" className="btn btn-secondary me-2" onClick={handleCloseDenyModal}>Hủy</button>
            ...
            >
                <div style={{ width: "500px" }} className="bg-white p-3 mt-5 position-absolute start-50 translate-middle-x">
                    ...
                    <div className="text-end">
                        <button type="button" className="btn btn-secondary me-2" onClick={handleCloseAcceptModal}>Hủy</button>
