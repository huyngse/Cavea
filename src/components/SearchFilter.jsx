...
export default function SearchFilter() {
  return (
    <form className='p-3'>
      <h1 className='h5 mb-3'><i className="bi bi-filter me-2"></i>Bộ lọc tìm kiếm</h1>
       {/* #################### */}
      {/*       LOẠI LỒNG        */}
      {/* #################### */}
      <div>
        ...
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="cgFilter" />
          <label className="form-check-label" htmlFor="cgFilter">
            Cu gáy (429)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="hmFilter" />
          <label className="form-check-label" htmlFor="hmFilter">
            Họa mi (469)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="cmFilter" />
          <label className="form-check-label" htmlFor="cmFilter">
            Chào mào (325)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="lkFilter" />
          <label className="form-check-label" htmlFor="lkFilter">
            Khuyên (322)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="ctFilter" />
          <label className="form-check-label" htmlFor="ctFilter">
            Chòe than (212)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="ckFilter" />
          <label className="form-check-label" htmlFor="ckFilter">
            Khướu (199)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="lyFilter" />
          <label className="form-check-label" htmlFor="lyFilter">
            Hút mật (165)
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="" id="clFilter" />
      ...
      <div>
        ...
        <div className='d-flex mb-3'>
          <input className="form-control rounded-0 border border-primary" type="text" placeholder="₫ Từ" aria-label="default input example" />
          <span className='px-4'>-</span>
          <input className="form-control rounded-0 border border-primary" type="text" placeholder="₫ Đến" aria-label="default input example" />
        </div>
      ...
      <div>
        ...
        <div className="form-check">
          ...
          <label className="form-check-label d-flex" htmlFor="rating4">
            <Rating name="read-only" value={4} readOnly className='me-2' /> trở lên
          </label>
        </div>
        <div className="form-check">
          ...
          <label className="form-check-label d-flex" htmlFor="rating3">
            <Rating name="read-only" value={3} readOnly className='me-2' /> trở lên
          </label>
        </div>
        <div className="form-check">
          ...
          <label className="form-check-label d-flex" htmlFor="rating2">
            <Rating name="read-only" value={2} readOnly className='me-2' /> trở lên
          </label>
        </div>
        <div className="form-check">
          ...
          <label className="form-check-label d-flex" htmlFor="rating1">
            <Rating name="read-only" value={1} readOnly className='me-2' /> trở lên
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="radio" name="flexRadioDefault" id="ratingAll" />
      ...
      <div>
        ...
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="flexRadioDefault" id="orderedFilter" />
          <label className="form-check-label" htmlFor="orderedFilter">
            Đã mua
          </label>
        </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="flexRadioDefault" id="newFilter" />
          <label className="form-check-label d-flex" htmlFor="newFilter">
            Mới
          </label>
        </div>
        <hr />
        <button className='btn btn-primary rounded-0 w-100' type='reset'>Xóa tất cả</button>
