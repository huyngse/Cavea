...
const OrderCard = (props) => {
    return (
        <div className='bg-white p-3 mb-3'>
            ...
            <div className='d-flex'>
                <button className='ms-auto btn btn-outline-primary me-3'>Xem chi tiết</button>
                {
                    props.status === "đã hủy" && <button className='btn btn-outline-primary me-3'>Xem chi tiết hủy đơn</button>
                }
