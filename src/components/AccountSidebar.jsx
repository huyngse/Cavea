  ...
  return (
    <div className="d-flex flex-column flex-shrink-0 p-4 bg-light">
      <a
        ...
        className="d-flex align-items-center link-dark text-decoration-none px-3"
      >
        <div
          className="object-fit-cover object-position-center rounded-circle overflow-hidden me-3"
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item">
          <a
            href="/account/profile"
            className={`nav-link ${
              location.pathname === "/account/profile" ? "active" : "link-dark"
            }`}
            aria-current={
        ...
        <li>
          <a
            href="/account/order"
            className={`nav-link ${
              location.pathname === "/account/order" ? "active" : "link-dark"
            }`}
            aria-current={
              location.pathname === "/account/order" ? "page" : undefined
            }
          >
        ...
        <li>
          <a
            href="/account/custom-order"
            className={`nav-link ${
              location.pathname === "/account/custom-order"
                ? "active"
                : "link-dark"
            }`}
            aria-current={
        ...
        <li>
          <a
            ...
            aria-current={
              location.pathname === "/account/notification" ? "page" : undefined
            }
          >
