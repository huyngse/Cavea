    ...
    <div className="col-3 mb-3">
      <div className="bg-white sm-product-card p-1 position-relative">
        <a href={props.href} className="text-dark text-decoration-none">
          ...
          <h3
            className="h6 overflow-hidden mb-0"
            style={{ height: "39px", textOverflow: "ellipsis" }}
          >
            {props.name}
          </h3>
        </a>
        ...
        <div className="d-flex align-items-center small text-muted">
          <div className="me-1">357 đã bán |</div>
          <Rating
            name="size-small"
        ...
        <div className="dropdown position-absolute top-0 end-0 m-2 hidden-hover">
          <button
            className="btn card-menu p-1 rounded-circle "
            type="button"
          ...
          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <button className="dropdown-item">
                <div className="form-check ">
                  <input
                    ...
                    type="checkbox"
                    value=""
                    id={"flexCheckDefault" + props.id}
                  />
                  <label
                    className="form-check-label"
                    htmlFor={"flexCheckDefault" + props.id}
                  >
                    So sánh
                  </label>
                </div>
            ...
            <li>
              <button className="dropdown-item">Thêm vào giỏ</button>
            </li>
            <li>
              <button className="dropdown-item">Mua ngay</button>
            </li>
          </ul>
        </div>
      </div>
