...
function AdminSideBar() {
  ...
  return (
    <div
      className="d-flex flex-column flex-shrink-0 py-3 px-1 bg-light min-vh-100"
      style={{ width: "250px" }}
    >
      <a
        href="/"
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        {/* <li className="nav-item">
          <a
            ...
            className={`nav-link ${
              location.pathname === "/admin/dashboard" ? "active" : "link-dark"
            }`}
            aria-current={
        ...
        <li>
          <a
            ...
            className={`nav-link ${
              currentURL === "/admin/manage-order" ||
              currentURL.includes("/admin/order-detail")
                ? "active"
                : "link-dark"
            }`}
            aria-current={
        ...
        <li>
          <a
            ...
            className={`nav-link ${
              location.pathname === "/admin/custom-order"
                ? "active"
                : "link-dark"
            }`}
            aria-current={
        ...
        {/* <li>
          <a
            href="/admin/revenue"
            className={`nav-link ${
              location.pathname === "/admin/revenue" ? "active" : "link-dark"
            }`}
            aria-current={
              location.pathname === "/account/profile" ? "page" : undefined
            }
